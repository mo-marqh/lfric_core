...
module sci_restrict_scalar_unweighted_kernel_mod
...
public :: restrict_scalar_unweighted_kernel_code
  ...
  interface restrict_scalar_unweighted_kernel_code
    module procedure  &
      restrict_scalar_unweighted_code_real32, &
      restrict_scalar_unweighted_code_real64
  end interface
...
contains
  ...
  ! REAL32 PRECISION
  ! ==================
  subroutine restrict_scalar_unweighted_code_real32(                &
                                           nlayers,                 &
                                           cell_map,                &
  ...
  end subroutine restrict_scalar_unweighted_code_real32
  ...
  end subroutine restrict_scalar_unweighted_code_real64


end module sci_restrict_scalar_unweighted_kernel_mod
