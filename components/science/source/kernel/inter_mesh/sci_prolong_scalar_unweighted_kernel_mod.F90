...
module sci_prolong_scalar_unweighted_kernel_mod
...
public :: prolong_scalar_unweighted_kernel_code
  ...
  interface prolong_scalar_unweighted_kernel_code
    module procedure  &
      prolong_scalar_unweighted_code_real32, &
      prolong_scalar_unweighted_code_real64
  end interface
...
contains
  ...
  end subroutine prolong_scalar_unweighted_code_real32
  ...
  end subroutine prolong_scalar_unweighted_code_real64


end module sci_prolong_scalar_unweighted_kernel_mod
